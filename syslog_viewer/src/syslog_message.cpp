...
std::string SyslogMessage::severity_string() const {
    switch (severity) {
        case SyslogSeverity::EMERGENCY: return "EMERG";
        case SyslogSeverity::ALERT: return "ALERT";
        case SyslogSeverity::CRITICAL: return "CRIT";
        case SyslogSeverity::ERROR: return "ERROR";
        case SyslogSeverity::WARNING: return "WARN";
        case SyslogSeverity::NOTICE: return "NOTICE";
        case SyslogSeverity::INFO: return "INFO";
...
std::string SyslogMessage::facility_string() const {
    switch (facility) {
        case SyslogFacility::KERN: return "kern";
...
SyslogMessage SyslogMessage::parse(const std::string& raw_message, const std::string& source_ip) {
    SyslogMessage msg;
